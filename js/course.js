...
const courseData = [
    ...
    { id: "2.1", title: "Bölüm 2: Navigasyon - cd", description: "cd komutu.", text: "Dizinler arası geçiş için <code>cd</code> kullanılır. <code>/</code> kök dizindir.", task: "Kök dizine gitmek için <code>cd /</code> yazın.", unlocked: ['pwd', 'clear', 'ls', 'cd'], checkCompletion: (cmd, fs) => fs.pwd() === '/' },
    ...
    { id: "34.1", title: "Bölüm 34: Diziler (Arrays)", description: "declare -a.", text: "Birden çok veriyi tek değişkende saklar.", task: "<code>bash scripts/array-mapfile /etc/passwd</code> yazın.", unlocked: [...baseUnlocked], checkCompletion: (cmd) => /bash\s+scripts\/array-mapfile/.test(cmd) },
